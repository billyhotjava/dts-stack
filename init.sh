...
generate_env_base(){
  ...
  : "${DTS_MDM_GATEWAY_REGISTRY_DATA_TYPE:=sync_demand}"
  ...
  # legacy keys for backward compatibility (application.yml still reads them)
...
# ====== MDM Gateway (legacy keys still read by application.yml) ======

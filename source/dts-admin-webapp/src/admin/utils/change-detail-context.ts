...
const FIELD_LABEL_FALLBACK_ENTRIES: Array<[string, string]> = [
	["FULLNAME", "姓名"],
	["FULL_NAME", "姓名"],
	["NAME", "姓名"],
	["DISPLAYNAME", "显示名称"],
	...
	["PERSONNELSECURITYLEVEL", "人员安全级别"],
	["PERSONNEL_SECURITY_LEVEL", "人员安全级别"],
	["MAXDATALEVEL", "最大数据密级"],
	...
	["MAXROWS", "最大行数"],
	["MAX_ROWS", "最大行数"],
	["ALLOWDESENSITIZEJSON", "允许脱敏 JSON"],
	["ALLOW_DESENSITIZE_JSON", "允许脱敏 JSON"],
	["TITLECN", "中文名称"],
	["NAMEZH", "中文名称"],
	["TITLEEN", "英文名称"],
	["OPERATIONS", "操作权限"],

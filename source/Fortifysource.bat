@echo off
REM ###########################################################################
REM Script generated by Fortify SCA Scan Wizard (c) 2011-2025 Micro Focus or one of its affiliates
REM Created on 2025/11/17 16:45:23
REM ###########################################################################
...
set FPR="Fortifysource.fpr"
set BUILDID="source"
set ARGFILE="Fortifysource.bat.args"
set BYTECODE_ARGFILE="Fortifysource.bat.bytecode.args"
set MEMORY=-Xmx25486M -Xms400M -Xss24M 
set LAUNCHERSWITCHES=""
set SCANSWITCHES=""
set OLDFILENUMBER="Fortifysource.bat.fileno"
set FILENOMAXDIFF=10
set ENABLE_BYTECODE=false

set PROJECTROOT0="Z:\opt\prod\s10\dts-stack\source"
...
:FINISHED
REM ARGS "-cp"
REM ARGS "PROJECTROOT0_MARKER\dts-common\target\classes;PROJECTROOT0_MARKER\dts-platform\target\dts-platform-0.0.1-SNAPSHOT.jar;PROJECTROOT0_MARKER\dts-platform\target\test-classes;PROJECTROOT0_MARKER\dts-admin\target\test-classes;PROJECTROOT0_MARKER\dts-admin\target\classes"
REM ARGS "-cp"
REM ARGS "PROJECTROOT0_MARKER\dts-common\target\dts-common-0.0.1-SNAPSHOT.jar;PROJECTROOT0_MARKER\dts-admin\.mvn\wrapper\maven-wrapper.jar;PROJECTROOT0_MARKER\dts-common\.mvn\wrapper\maven-wrapper.jar;PROJECTROOT0_MARKER\dts-platform\.mvn\wrapper\maven-wrapper.jar;PROJECTROOT0_MARKER\dts-admin\target\dts-admin-0.0.1-SNAPSHOT.jar"
REM ARGS "-cp"
REM ARGS "PROJECTROOT0_MARKER\dts-platform\target\surefire\surefirebooter-20251117164122672_3.jar;PROJECTROOT0_MARKER\dts-platform\target\classes"
REM ARGS "-source"
REM ARGS "1.8"

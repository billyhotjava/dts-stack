...
public class ClassificationUtils {
     ...
     * Order by presence of realm roles: ROLE_TOP_SECRET > ROLE_SECRET > ROLE_INTERNAL > ROLE_PUBLIC.
     * Falls back to property dts.platform.default-user-classification when roles are not present.
     */

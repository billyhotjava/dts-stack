...
public enum AdminAuditOperation {
    ...
    ADMIN_MENU_DISABLE("ADMIN_MENU_DISABLE", "禁用门户菜单", AuditOperationType.UPDATE, "admin.portal-menus", "门户菜单", "portal_menu"),
    ADMIN_MENU_ENABLE("ADMIN_MENU_ENABLE", "启用门户菜单", AuditOperationType.UPDATE, "admin.portal-menus", "门户菜单", "portal_menu"),
    ADMIN_DATA_SOURCE_CREATE("ADMIN_DATA_SOURCE_CREATE", "新增数据源", AuditOperationType.CREATE, "admin.infra", "基础设施", "infra_data_source"),
    ADMIN_DATA_SOURCE_UPDATE("ADMIN_DATA_SOURCE_UPDATE", "更新数据源", AuditOperationType.UPDATE, "admin.infra", "基础设施", "infra_data_source"),
    ADMIN_DATA_SOURCE_PUBLISH("ADMIN_DATA_SOURCE_PUBLISH", "发布 Inceptor 数据源", AuditOperationType.UPDATE, "admin.infra", "基础设施", "infra_data_source"),
    ADMIN_DATA_SOURCE_TEST("ADMIN_DATA_SOURCE_TEST", "测试数据源连接", AuditOperationType.TEST, "admin.infra", "基础设施", "infra_data_source"),
    ADMIN_DATA_SOURCE_UPLOAD_KRB5("ADMIN_DATA_SOURCE_UPLOAD_KRB5", "上传 krb5.conf", AuditOperationType.UPLOAD, "admin.infra", "基础设施", "infra_data_source"),
    ADMIN_DATA_SOURCE_UPLOAD_KEYTAB("ADMIN_DATA_SOURCE_UPLOAD_KEYTAB", "上传 Keytab 文件", AuditOperationType.UPLOAD, "admin.infra", "基础设施", "infra_data_source"),

...
const ACTIONS: Record<string, string[]> = {
	user: ["CREATE", "UPDATE", "DELETE", "BIND_ROLE", "UNBIND_ROLE"],
	role: ["CREATE", "UPDATE", "DELETE"],
	org: ["CREATE", "UPDATE", "DELETE"],
	config: ["CONFIG_SET"],
	...(GLOBAL_CONFIG.enablePortalMenuMgmt ? { menu: ["CREATE", "UPDATE", "DELETE"] } : {}),
};
...
const TABS = [
	...
	...(GLOBAL_CONFIG.enablePortalMenuMgmt ? [{ key: "menu", label: "菜单管理" }] : []),
] as const;

...
const authadminMenus: AdminMenuItem[] = [
	{ key: "approval", label: "审批中心", path: "/admin/approval", icon: "solar:verify-outline" },
	{ key: "rules", label: "审批规则", path: "/admin/approval?tab=rules", icon: "solar:book-outline" },
	{ key: "audit", label: "审计日志", path: "/admin/audit", icon: "solar:history-bold" },
];

const auditMenus: AdminMenuItem[] = [
	{ key: "audit", label: "审计日志", path: "/admin/audit", icon: "solar:history-bold" },
	{ key: "login", label: "登录/登出日志", path: "/admin/audit?tab=login", icon: "solar:door-open-bold" },
];

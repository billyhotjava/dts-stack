...
export const GOVERNANCE_ROLE_NAMES = ["ROLE_SYS_ADMIN", "ROLE_AUTH_ADMIN", "ROLE_SECURITY_AUDITOR"] as const;
export const APPLICATION_ROLE_NAMES = ["ROLE_OP_ADMIN"] as const;
export const DATA_ROLE_NAMES = ["DATA_PUBLIC", "DATA_INTERNAL", "DATA_SECRET", "DATA_CONFIDENTIAL"] as const;

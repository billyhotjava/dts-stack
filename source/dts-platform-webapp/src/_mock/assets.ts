		...
		},
		{
			...
			children: [
				...
				},
				{
					id: "0157880245365435",
					parentId: "0249937641030250",
					label: "sys.nav.system.approval",
					name: "Approval",
					type: PermissionType.MENU,
					route: "approval",
					component: "/management/system/approval/index.tsx",
				},
			],
		},
	],
...
export const ADMIN_PERMISSION_LIST = [DASHBOARD_PERMISSION, MANAGEMENT_PERMISSION];
...
const ADMIN_ROLE = {
	...
	order: 1,
	desc: "Super Admin",
	permission: ADMIN_PERMISSION_LIST,
};
const TEST_ROLE = {
	id: "9931665660771476",
	name: "Test",
